...
@section('content')
    ...
    <h2>Reservasi</h2>
    <form id="reservasiForm" onsubmit="konfirmasiReservasi(event)">
        <!-- Konten reservasi -->
        ...
        <label>Tanggal dan Jam Reservasi:</label>
        <input type="datetime-local" id="tanggalJamReservasi" required><br>

        <input type="submit" value="Konfirmasi Reservasi">
    </form>
    ...
    <script>
        ...
        function konfirmasiReservasi(event) {
            ...
            var tanggalJamReservasi = document.getElementById("tanggalJamReservasi").value;
            ...
            var reservasiContainer = document.getElementById("reservasiContainer");
            reservasiContainer.innerHTML = "<h3>Reservasi:</h3><p><strong>Nama Pelanggan:</strong> " + namaPelanggan + "</p><p><strong>Nomor Meja:</strong> " + nomorMeja + "</p><p><strong>Nomor Pesanan:</strong> " + nomorPesanan + "</p><p><strong>Tanggal dan Jam Reservasi:</strong> " + tanggalJamReservasi + "</p><h3>Pesanan yang Dipesan:</h3><table><tr><th>No</th><th>Menu</th><th>Jumlah Pesanan</th><th>Jenis Menu</th><th>Catatan</th></tr>";
            for (var j = 0; j < daftarPesanan.length; j++) {
                var pesanan = daftarPesanan[j];
                reservasiContainer.innerHTML += "<tr><td>" + (j + 1) + "</td><td>" + pesanan.menu + "</td><td>" + pesanan.jumlahPesanan + "</td><td>" + pesanan.jenisMenu + "</td><td>" + pesanan.catatan + "</td></tr>";
            }
            reservasiContainer.innerHTML += "</table>";
